...
export const headData = {
  ...
  description: 'Jack-of-all-codes: I\'m a diverse developer, trying to learn something new every day.', // e.g: Welcome to my website
};
...
export const projectsData = [
  {
    ...
    img: 'netatmo.png',
    title: 'Netatmo Shop',
    info: 'Complete rebuild of their old Magento 1 shop in Magento 2. For improved performance, security, and developer experience we use Magento 2 as a headless CMS and eCommerce platform. The frontend was built as a PWA in Vue Storefront, allowing us to use Vue, Express (as a middleware API of sorts), and ElasticSearch for the data storage.',
    info2: '',
  ...
  },
  {
    ...
    info: 'I joined mid-project to take over the technical project management, and eventually taking over all technical responsibilities for this startup. It is a new website and web app build for connecting pet owners with pet service providers.',
  ...
  },
  {
    ...
    info: 'This was a learning experience for me, to build a static site using React and Netlify. I did start with a theme, because I am not strong in design, and didn\'t want to waste hours trying to come up with a design for my portfolio.',
    info2: '',
    role: 'Developer',
    stack: [
      { name: 'Gatsby', url: 'https://www.gatsbyjs.com/' },
      { name: 'gatsby-simplefolio', url: 'https://www.gatsbyjs.com/starters/cobidev/gatsby-simplefolio' },
  ...
  },
  {
    ...
    info: 'This is a fun project idea I had, to randomly watch a "How do you want to do this?" moment from the internet show Critical Role. It was also a way for me to spend some more time learning React.',
    info2: '',
    role: 'Developer',
    stack: [
      { name: 'React', url: 'https://reactjs.org/' },
  ...
  },
  {
    ...
    info: 'The application serves as a platform for moms who have left the workforce and are having difficulty jumping back in, providing access to job listings from companies interested in working with them as well as dedicated recruiters to help find the right job. The application was designed and developed by Pyxl on the Laravel framework. I was brought on to the project as a technical lead towards the end as some events led to an unfortunate situation in the project. Once brought on I helped bring the project back on track, provided some final development and bug fixes, participated in a 20 hour live QA session with a team of developers, and worked with the client’s CTO to bring both teams back to the same page for the final project launch.',
    info2: '',
  ...
  },
  {
    ...
    img: 'teamhealth.png',
    title: 'TeamHealth',
    info: 'I provided ongoing support and new feature development. The site was built (not by me) using Sitecore as the CMS and React as a separated front-end layer. Ongoing support involved updating existing features and building new features in both React and Sitecore.',
    info2: '',
    role: 'Lead Developer',
    stack: [
